...
/*
* === 결제 시스템 구현 ===
* 스프링 부트 + JPA + PG(Payment Gateway) 연동
*
* cf) PG: 온라인 쇼핑몰에서 다양한 결제 수단(카드결제, 계좌 이체 등)을
...
*
*   4) 서비스에서 Payment 엔티티 생성(PaymentResult를 기바능로)
*
...
*
*   7) 환불 요청
*       : 본인 소유 결제인지, 상태 SUCCESS 인지, 금액 유효한지 등을 확인 후 홙불
*
* */
public class 개요 {
}
